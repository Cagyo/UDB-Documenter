...
namespace UDBDocumenter
{
    public class Server
    {
        ...
        public Server(string ip, int port, string serverName, string userName, string password, MySQLServerEngine engine)
        {
            databases = new List<Database>();
            this.ip = ip;
            this.port = port;
        ...
        {
            return engine.InitialGetServerStructure();
        }
        ...
        {
            return engine.IsDatabaseDocumented(databaseName);
        }
